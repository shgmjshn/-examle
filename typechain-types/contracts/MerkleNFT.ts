...
export interface MerkleNFTInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "approve"
      | "balanceOf"
...
export interface MerkleNFT extends BaseContract {
  connect(runner?: ContractRunner | null): MerkleNFT;
  waitForDeployment(): Promise<this>;

  interface: MerkleNFTInterface;
